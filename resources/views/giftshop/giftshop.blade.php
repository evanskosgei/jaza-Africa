    ...
    <div class="breadcumb-wrapper" data-bg-src="assets/img/bg/breadcumb-bg.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Gift Shops</h1>
                        ...
                        <div class="row gy-40">
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    <div class="product-img"><img src="assets/img/product/product_1_1.png"
                                            alt="Product Image"> <span class="product-tag">Sale</span>
                                        <div class="actions"><a href="#QuickView" class="icon-btn popup-content"><i
                                                    class="far fa-eye"></i></a> <a href="{{ route('cart') }}" class="icon-btn"><i
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    <div class="product-img"><img src="assets/img/product/product_1_2.png"
                                            alt="Product Image"> <span class="product-tag">Sale</span>
                                        <div class="actions"><a href="#QuickView" class="icon-btn popup-content"><i
                                                    class="far fa-eye"></i></a> <a href="{{ route('cart') }}" class="icon-btn"><i
                                                    class="far fa-cart-plus"></i></a> <a href="wishlist.html"
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    <div class="product-img"><img src="assets/img/product/product_1_3.png"
                                            alt="Product Image"> <span class="product-tag">New</span>
                                        <div class="actions"><a href="#QuickView" class="icon-btn popup-content"><i
                                                    class="far fa-eye"></i></a> <a href="{{ route('cart') }}" class="icon-btn"><i
                                                    class="far fa-cart-plus"></i></a> <a href="wishlist.html"
                                                class="icon-btn"><i class="far fa-heart"></i></a></div>
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-details.html">Hamok</a></h3><span
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    <div class="product-img"><img src="assets/img/product/product_1_4.png"
                                            alt="Product Image"> <span class="product-tag">Sale</span>
                                        <div class="actions"><a href="#QuickView" class="icon-btn popup-content"><i
                                                    class="far fa-eye"></i></a> <a href="{{ route('cart') }}" class="icon-btn"><i
                                                    class="far fa-cart-plus"></i></a> <a href="wishlist.html"
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-details.html">Beach Hat</a></h3><span
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    <div class="product-img"><img src="assets/img/product/product_1_5.png"
                                            alt="Product Image"> <span class="product-tag">New</span>
                                        <div class="actions"><a href="#QuickView" class="icon-btn popup-content"><i
                                                    class="far fa-eye"></i></a> <a href="{{ route('cart') }}" class="icon-btn"><i
                                                    class="far fa-cart-plus"></i></a> <a href="wishlist.html"
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-details.html">Sony Black Headphone</a>
                                        </h3><span class="price">$65.00</span>
                                        <div class="woocommerce-product-rating"><span class="count">(5.00 Review)</span>
                                            <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                                <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span
                                                        class="rating">1</span> customer rating</span>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    <div class="product-img"><img src="assets/img/product/product_1_6.png"
                                            alt="Product Image"> <span class="product-tag">Sale</span>
                                        <div class="actions"><a href="#QuickView" class="icon-btn popup-content"><i
                                                    class="far fa-eye"></i></a> <a href="{{ route('cart') }}" class="icon-btn"><i
                                                    class="far fa-cart-plus"></i></a> <a href="wishlist.html"
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-details.html">Hoodie With Zipper</a>
                                        </h3><span class="price">$35.00</span>
                                        <div class="woocommerce-product-rating"><span class="count">(5.00 Review)</span>
                                            <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                                <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span
                                                        class="rating">1</span> customer rating</span>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    <div class="product-img"><img src="assets/img/product/product_1_7.png"
                                            alt="Product Image"> <span class="product-tag">New</span>
                                        <div class="actions"><a href="#QuickView" class="icon-btn popup-content"><i
                                                    class="far fa-eye"></i></a> <a href="{{ route('cart') }}" class="icon-btn"><i
                                                    class="far fa-cart-plus"></i></a> <a href="wishlist.html"
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="th-product product-grid">
                                    <div class="product-img"><img src="assets/img/product/product_1_8.png"
                                            alt="Product Image"> <span class="product-tag">Sale</span>
                                        <div class="actions"><a href="#QuickView" class="icon-btn popup-content"><i
                                                    class="far fa-eye"></i></a> <a href="{{ route('cart') }}" class="icon-btn"><i
                                                    class="far fa-cart-plus"></i></a> <a href="wishlist.html"
                        ...
                        <div class="row gy-30">
                            <div class="col-md-6">
                                <div class="th-product list-view">
                                    <div class="product-img"><img src="assets/img/product/product_1_1.png"
                                            alt="Product Image">
                                        <div class="actions"><a href="{{ route('cart') }}" class="icon-btn"><i
                                                    class="far fa-cart-plus"></i></a></div>
                                    </div>
                                    <div class="product-content"><span class="price">$250.00<del>$550.00</del></span>
                                        <h3 class="product-title"><a href="shop-details.html">beach casual-shoe</a></h3>
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated
                            ...
                            <div class="col-md-6">
                                <div class="th-product list-view">
                                    ...
                                    <div class="product-content"><span class="price">$220.00</span>
                                        <h3 class="product-title"><a href="shop-details.html">Beach football</a></h3>
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated
                                                <strong class="rating">5.00</strong> out of 5 based on <span
                            ...
                            <div class="col-md-6">
                                <div class="th-product list-view">
                                    ...
                                    <div class="product-content"><span class="price">$240.00</span>
                            ...
                            <div class="col-md-6">
                                <div class="th-product list-view">
                                    ...
                                    <div class="product-content"><span class="price">$265.00</span>
                            ...
                            <div class="col-md-6">
                                <div class="th-product list-view">
                                    ...
                                    <div class="product-content"><span class="price">$235.00</span>
                                        <h3 class="product-title"><a href="shop-details.html">Sony Black Headphone</a>
                                        </h3>
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated
                            ...
                            <div class="col-md-6">
                                <div class="th-product list-view">
                                    ...
                                    <div class="product-content"><span class="price">$225.00</span>
                                        <h3 class="product-title"><a href="shop-details.html">Hoodie With Zipper</a>
                                        </h3>
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated
