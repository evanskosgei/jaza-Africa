                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="tour-page-single">
                            ...
                            <div class="swiper th-slider mb-4" id="tourSlider4"
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img"><img src="assets/img/tour/tour_inner_2_1.jpg"
                                                alt="img"></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img"><img src="assets/img/tour/tour_inner_2_2.jpg"
                                                alt="img"></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img"><img src="assets/img/tour/tour_inner_2_3.jpg"
                                                alt="img"></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img"><img src="assets/img/tour/tour_inner_2_4.jpg"
                                                alt="img"></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tour-slider-img"><img src="assets/img/tour/tour_inner_2_1.jpg"
                        ...
                        <div class="page-content">
                            <div class="page-meta mb-45"><a class="page-tag" href="tour.html">Featured</a> <span
                            ...
                            <div class="tour-snapshot">
                                ...
                                <div class="tour-snap-wrapp">
                                    <div class="tour-snap">
                                        ...
                                        <div class="content"><span class="title">Duration:</span> <span>8h</span></div>
                                    </div>
                                    <div class="tour-snap">
                                        <div class="icon"><img src="assets/img/icon/guide2.svg" alt=""></div>
                                        <div class="content"><span class="title">Group Size:</span> <span>12</span>
                                        </div>
                                    </div>
                                    <div class="tour-snap">
                                        <div class="icon"><img src="assets/img/icon/ship.svg" alt=""></div>
                                        <div class="content"><span class="title">Near Public</span>
                                            <span>Transportation</span>
                                        </div>
                                    </div>
                                    <div class="tour-snap">
                                        <div class="icon"><img src="assets/img/icon/01.svg" alt=""></div>
                                        <div class="content"><span class="title">Free Cancellation</span> <a
                                                href="#" class="line-btn">Learn more</a></div>
                                    </div>
                                </div>
                            </div>
                            <h2 class="box-title">Overview</h2>
                            <p class="box-text mb-50">voluptatem accusantium doloremque laudantium, totam rem aperiam,
                                eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt
                                explicabo. Dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non
                                numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat
                                voluptatem. Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam
                        ...
                        <div class="location-map">
                            ...
                            <div class="contact-map">
                                ...
                                <div class="contact-icon"><img src="assets/img/icon/location-dot3.svg" alt="">
                                </div>
                            </div>
                        </div>
